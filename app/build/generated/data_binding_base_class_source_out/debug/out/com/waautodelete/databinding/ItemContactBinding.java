...
public final class ItemContactBinding implements ViewBinding {
  ...
  private ItemContactBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnRemove,
  ...
  public static ItemContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemContactBinding((LinearLayout) rootView, btnRemove, tvContactName);
    }
